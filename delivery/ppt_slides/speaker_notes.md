# CS6493 Speaker Notes

## 01. Mathematical Reasoning in Small Open-Weight LLMs
...
## 02. Can structured prompting improve math reasoning under limited compute?
...
## 03. A controlled small-model benchmark across three math splits
...
## 04. The experiment records the full reasoning trajectory, not only the final answer
...
## 05. Three intervention levels: prompt context, inference structure, and tool loop
...
## 06. Single-turn, multi-sample, multi-turn, and tool-loop methods have different cost surfaces
...
## 07. Small reasoning models fail in more than one way
...
## 08. Each method changes a different part of the reasoning process
...
## 09. Plan-and-Solve moves structure before execution
...
## 10. TIR turns math solving into a compact action-observation loop
...
## 11. Single metrics hide different failure modes
...
## 12. Correctness gates the score; efficiency adjusts the remaining credit
...
## 13. Factor and variable design make the score interpretable
...
## 14. Joint score comparison highlights the proposed methods
...
## 15. Factor diagnostics separate efficient gains from expensive gains
...
## 16. Backbone strength changes how much structure can be exploited
...
## 17. Dataset joint-score matrix shows where the gains really transfer
...
## 18. The design borrows ideas from prompting, tool use, and reasoning efficiency
...
## 19. From static prompts to adaptive solver agents
- Kicker: Future Work
...
## 20. Prompt design and metric design must be discussed together
- Kicker: Takeaways
- Takeaway: Q&A
